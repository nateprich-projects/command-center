...
protected-path touches, and the stop-auto-merging counter. #798 assembled
the evidence; #799 adds the deterministic pre-check rows the runner
evaluates before any model is called. The model call itself comes later.
