...
def stranded_items(
    ...
    ``not_planned``, plus cycles formed by native or parsed block edges.
    Missing CI history is intentionally absent; no fetched fact distinguishes
    that from a PR whose first check is still pending.
