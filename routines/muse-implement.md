...
remote, use the prior-run evidence and actual diff to decide whether to continue
or reset. When it has an open PR, inspect the branch and PR with `gh` first;
before deciding, read the newest `<!-- command-center-review -->` verdict
