...
def test_the_floor_does_not_license_spending_the_week_on_day_one():
    ...
    Raised to 50.0 on 2026-09-06 and reverted the same day: at 50.0 this case
    passed, which was the point — the floor had stopped being an allowance and
    become a licence to spend Nate's week on the automations. The floor cannot
    solve routine starvation, because moving it only decides who goes without.
    """
