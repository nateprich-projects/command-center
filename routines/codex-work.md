...
```bash
python3 /Users/nateprich/.claude/command-center-run/funnel.py capture "<short defect title>" --repo <repo-from-the-ticket> --origin agent --class <Broken|Maintenance|Improve|New|Replace> --note "<observed evidence; say why you chose this class, and say plainly when you are unsure>"
```
